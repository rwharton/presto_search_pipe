...
############
#sys.exit()
cands_dir = "/hercules/results/rwharton/phased_gc/day2/search/cands_presto"
best_dir = "%s/top_plots" %(cands_dir)
cand_file = "%s/sgra_day2.ACCEL_100.sifted.cands" %cands_dir
...
out_idx = parse_harmonics_r(candlist, n=4, r_err=100, grow=False, verbose=False)
...
fits_dir   = "/hercules/results/rwharton/phased_gc/day2/psrfits"
search_dir = "/hercules/results/rwharton/phased_gc/day2/search"

run_prepfold_topcands(good_file, fits_dir, search_dir, 100, None, None, searchtype='none', start=start, stop=stop)
